...
namespace HAF.Web.Security
{
    public class RequireHttpsHandler : DelegatingHandler
    {
        ...
        /// <remarks>
        ///     <para>
        ///         If the request method was GET, the caller is automatically redirected (Code 302). Otherwise, a 404 is
        ///         returned.
        ///     </para>
        ///     <para>
        ///         Based on
        ...
        private HttpResponseMessage CreateResponse(HttpRequestMessage request)
        {
            ...
            var body = string.Format(
                "HTTPS is required<br/>The resource can be found at <a href=\"{0}\">{0}</a>.",
                uri.Uri.AbsoluteUri);
